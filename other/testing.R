...
loxcoder::pack(loxcoder::get_cass_vec(get_data(t)$code), get_data(t)$is_valid)
loxcoder::pack(get_data(t)$code, get_data(t)$is_valid)

t <- loxcoder::makeid(t)

# try loading some distance maps
loxcoder::load_origin_distmaps('maps/origin')
loxcoder::retrieve_dist_origin(get_data(t)$id, get_data(t)$size)
